...
from pintool import *
from triton  import ARCH, OPCODE, REG
...
def looking_for_main_addr(instruction):
    ...
    if MAIN_ADDR is None and instruction.getType() == OPCODE.CALL:
        ...
        MAIN_ADDR = getCurrentRegisterValue(getTritonContext().getRegister(REG.X86_64.RDI))
...
def looking_for_stack_base_addr():
    ...
    if STACK_BASE is None:
        STACK_BASE = getCurrentRegisterValue(getTritonContext().getRegister(REG.X86_64.RSP))
