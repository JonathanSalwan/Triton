...
if __name__ == '__main__':
    ...
    print 'RAX value   :', hex(Triton.getConcreteRegisterValue(REG.RAX))
    print 'RSI value   :', hex(Triton.getConcreteRegisterValue(REG.RSI))
    print 'RDI value   :', hex(Triton.getConcreteRegisterValue(REG.RDI))
    ...
    print '~~~~~~~~~~~~~~~~~~~~~'
    ah  = Triton.buildSymbolicRegister(REG.AH)
