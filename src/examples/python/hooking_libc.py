...
from triton import TritonContext, ARCH, REG, CPUSIZE, MemoryAccess, OPCODE, Elf, Instruction
...
if __name__ == '__main__':
    ...
    Triton.setConcreteRegisterValue(Triton.getRegister(REG.X86_64.RSP), 0x6fffffff)
