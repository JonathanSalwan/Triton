...
from triton import ARCH, TritonContext, Elf, REG, CPUSIZE, MemoryAccess, Instruction, OPCODE
...
def __printf_chk():
    ...
    arg2   = getFormatString(Triton.getConcreteRegisterValue(Triton.getRegister(REG.X86_64.RSI)))
