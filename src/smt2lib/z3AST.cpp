...
void Z3ast::operator()(smt2lib::smtAstBvrolNode& e) {
  reg_size   op1 = boost::numeric_cast<reg_size>(reinterpret_cast<smt2lib::smtAstDecimalNode*>(e.getChilds()[0])->getValue());
  Z3Result op2 = this->eval(*e.getChilds()[1]);
...
void Z3ast::operator()(smt2lib::smtAstBvNode& e) {
  ...
  z3::expr newexpr = this->result.getContext().bv_val(value.getStringValue().c_str(), size.getreg_sizeValue());
...
void Z3ast::operator()(smt2lib::smtAstExtractNode& e) {
  ...
  z3::expr newexpr = to_expr(this->result.getContext(), Z3_mk_extract(this->result.getContext(), high.getreg_sizeValue(), low.getreg_sizeValue(), value.getExpr()));
...
void Z3ast::operator()(smt2lib::smtAstSxNode& e) {
  ...
  z3::expr newexpr = to_expr(this->result.getContext(), Z3_mk_sign_ext(this->result.getContext(), i.getreg_sizeValue(), value.getExpr()));
...
void Z3ast::operator()(smt2lib::smtAstVariableNode& e) {
  ...
  if (symVar->getSymVarKind() == SymVar::kind::MEM) {
    reg_size memSize   = symVar->getSymVarSize();
...
void Z3ast::operator()(smt2lib::smtAstZxNode& e) {
  Z3Result i = this->eval(*e.getChilds()[0]);
  Z3Result value = this->eval(*e.getChilds()[1]);
  z3::expr newexpr = to_expr(this->result.getContext(), Z3_mk_zero_ext(this->result.getContext(), i.getreg_sizeValue(), value.getExpr()));
