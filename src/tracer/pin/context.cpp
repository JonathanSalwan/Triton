      ...
      triton::uint512 getCurrentRegisterValue(const triton::arch::Register& reg) {
        ...
        triton::uint512 value = 0;
          ...
          switch (reg.getParent()) {
            ...
            case triton::arch::ID_REG_X86_ZMM0:    return 0; /* Pin doesn't support AVX-512 */
            case triton::arch::ID_REG_X86_ZMM1:    return 0; /* Pin doesn't support AVX-512 */
            case triton::arch::ID_REG_X86_ZMM2:    return 0; /* Pin doesn't support AVX-512 */
            case triton::arch::ID_REG_X86_ZMM3:    return 0; /* Pin doesn't support AVX-512 */
            case triton::arch::ID_REG_X86_ZMM4:    return 0; /* Pin doesn't support AVX-512 */
            case triton::arch::ID_REG_X86_ZMM5:    return 0; /* Pin doesn't support AVX-512 */
            case triton::arch::ID_REG_X86_ZMM6:    return 0; /* Pin doesn't support AVX-512 */
            case triton::arch::ID_REG_X86_ZMM7:    return 0; /* Pin doesn't support AVX-512 */
            case triton::arch::ID_REG_X86_ZMM8:    return 0; /* Pin doesn't support AVX-512 */
            case triton::arch::ID_REG_X86_ZMM9:    return 0; /* Pin doesn't support AVX-512 */
            case triton::arch::ID_REG_X86_ZMM10:   return 0; /* Pin doesn't support AVX-512 */
            case triton::arch::ID_REG_X86_ZMM11:   return 0; /* Pin doesn't support AVX-512 */
            case triton::arch::ID_REG_X86_ZMM12:   return 0; /* Pin doesn't support AVX-512 */
            case triton::arch::ID_REG_X86_ZMM13:   return 0; /* Pin doesn't support AVX-512 */
            case triton::arch::ID_REG_X86_ZMM14:   return 0; /* Pin doesn't support AVX-512 */
            case triton::arch::ID_REG_X86_ZMM15:   return 0; /* Pin doesn't support AVX-512 */
            ...
            default:
              if (reg.getId() >= triton::arch::ID_REG_X86_AF && reg.getId() <= triton::arch::ID_REG_X86_ZF)
