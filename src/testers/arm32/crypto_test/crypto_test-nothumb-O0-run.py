...
def memsetHandler(ctx):
    ...
    for i in range(0, arg3):
        ctx.setConcreteMemoryValue(arg1 + i, arg2)
...
customRelocation = [
    ...
    ('memset',         memsetHandler,       BASE_PLT + 3 * 8),
    ('memcpy',         memcpyHandler,       BASE_PLT + 4 * 8),
    ('__aeabi_memclr', aeabi_memclrHandler, BASE_PLT + 5 * 8),
    ('__aeabi_memcpy', aeabi_memcpyHandler, BASE_PLT + 6 * 8),
]
