...
# Simulate the aeabi_memclr4() function
def aeabi_memclr4Handler(ctx):
    print('[+] __aeabi_memclr4 (calling __aeabi_memclr)')
...
customRelocation = [
    ...
    ('strlen',          strlenHandler,        BASE_PLT + 1 * 8),
    ('printf',          printfHandler,        BASE_PLT + 2 * 8),
    ('__aeabi_memclr4', aeabi_memclr4Handler, BASE_PLT + 3 * 8),
    ('__aeabi_memclr',  aeabi_memclrHandler,  BASE_PLT + 4 * 8),
    ('__aeabi_memcpy',  aeabi_memcpyHandler,  BASE_PLT + 5 * 8),
]
