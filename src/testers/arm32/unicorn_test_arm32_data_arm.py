...
CODE  = [
    ...
    (b"\x38\x10\x40\x03", "movteq r1, #0x188"),
    (b"\x38\x10\x40\x13", "movtne r1, #0x188"),
    (b"\x38\x10\x40\x23", "movtcs r1, #0x188"),
    (b"\x38\x10\x40\x33", "movtcc r1, #0x188"),
    (b"\x38\x10\x40\x43", "movtmi r1, #0x188"),
    (b"\x38\x10\x40\x53", "movtpl r1, #0x188"),
    (b"\x38\x10\x40\x63", "movtvs r1, #0x188"),
    (b"\x38\x10\x40\x73", "movtvc r1, #0x188"),
    (b"\x38\x10\x40\x83", "movthi r1, #0x188"),
    (b"\x38\x10\x40\x93", "movtls r1, #0x188"),
    (b"\x38\x10\x40\xa3", "movtge r1, #0x188"),
    (b"\x38\x10\x40\xb3", "movtlt r1, #0x188"),
    (b"\x38\x10\x40\xc3", "movtgt r1, #0x188"),
    (b"\x38\x10\x40\xd3", "movtle r1, #0x188"),
    (b"\x38\x10\x40\xe3", "movtal r1, #0x188"),
