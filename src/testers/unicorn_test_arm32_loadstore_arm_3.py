...
SIZE  = 5 * 1024 * 1024
CODE  = [
    (b"\x03\x00\xbd\xe8", "pop {r0, r1}"),
    (b"\x01\x01\xbd\xe8", "pop {r0, r8}"),
    (b"\xff\x01\xbd\xe8", "pop {r0 - r8}"),

    (b"\x3c\x01\xbd\x08", "popeq {r2 - r5, r8}"),
    (b"\x3c\x01\xbd\x18", "popne {r2 - r5, r8}"),
    (b"\x3c\x01\xbd\x28", "popcs {r2 - r5, r8}"),
    (b"\x3c\x01\xbd\x38", "popcc {r2 - r5, r8}"),
    (b"\x3c\x01\xbd\x48", "popmi {r2 - r5, r8}"),
    (b"\x3c\x01\xbd\x58", "poppl {r2 - r5, r8}"),
    (b"\x3c\x01\xbd\x68", "popvs {r2 - r5, r8}"),
    (b"\x3c\x01\xbd\x78", "popvc {r2 - r5, r8}"),
    (b"\x3c\x01\xbd\x88", "pophi {r2 - r5, r8}"),
    (b"\x3c\x01\xbd\x98", "popls {r2 - r5, r8}"),
    (b"\x3c\x01\xbd\xa8", "popge {r2 - r5, r8}"),
    (b"\x3c\x01\xbd\xb8", "poplt {r2 - r5, r8}"),
    (b"\x3c\x01\xbd\xc8", "popgt {r2 - r5, r8}"),
    (b"\x3c\x01\xbd\xd8", "pople {r2 - r5, r8}"),
    (b"\x3c\x01\xbd\xe8", "popal {r2 - r5, r8}"),
]
