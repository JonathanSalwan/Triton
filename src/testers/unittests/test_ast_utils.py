...
class TestAstUtils(unittest.TestCase):
    ...
    def test_refUnroll(self):
        ...
        self.assertEqual(str(self.astCtxt.refUnroll(r2)), "SymVar_0")
        self.assertEqual(str(self.astCtxt.refUnroll(r1)), "SymVar_0")
        self.assertEqual(str(self.astCtxt.refUnroll(self.v1)), "SymVar_0")
