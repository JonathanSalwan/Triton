...
class TestSymbolic(unittest.TestCase):
    ...
    def test_backup(self):
        ...
        * Also check reseting a disable symbolic engines doesn't crash.
        ...
        self.assertEqual(self.Triton.getSymbolicRegisterValue(REG.RAX), 1)
        ...
        self.assertEqual(self.Triton.getConcreteRegisterValue(REG.RAX), 2, "concrete value is updated")
        self.assertEqual(self.Triton.getSymbolicRegisterValue(REG.RAX), 1)
        self.assertEqual(self.Triton.getSymbolicRegisterValue(REG.RAX), 1, "Symbolic value is not update")
    ...
    def test_bind_expr_to_register(self):
        ...
        self.Triton.assignSymbolicExpressionToRegister(expr1, REG.RAX)

        self.assertEqual(self.Triton.getSymbolicRegisterValue(REG.RAX), 0x11223344)
