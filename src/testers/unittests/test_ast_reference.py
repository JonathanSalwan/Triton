...
class TestAstReference(unittest.TestCase):
    ...
    def test_unroll_ssa_ref(self):
        ...
        self.assertEqual(str(self.Triton.unrollAst(ref0)), "SymVar_0_8")
        self.assertEqual(str(self.Triton.unrollAst(ref1)), "SymVar_1_8")
        self.assertEqual(str(self.Triton.unrollAst(ref2)), "(bvadd SymVar_0_8 (_ bv2 8))")
        self.assertEqual(str(self.Triton.unrollAst(ref3)), "(bvadd SymVar_0_8 SymVar_1_8)")
    ...
    def test_unroll_ssa_deep_ref(self):
        ...
        self.assertEqual(str(self.Triton.unrollAst(exp2.getAst())), "SymVar_0_8")
