...
class TestAstEval(unittest.TestCase):
    ...
    def test_sdiv(self):
        ...
        tests = [
            ...
            bvsdiv(zx(64, bv(18446744073709318393, 64)),
                   sx(64, bv(18446744073709551571, 64))),
            bvsdiv(zx(64, bv(9223372036854775808, 64)),
    ...
    def test_udiv(self):
        ...
        tests = [
            ...
            bvudiv(zx(64, bv(18446744073709318393, 64)),
                   sx(64, bv(18446744073709551571, 64))),
            bvudiv(zx(64, bv(9223372036854775808, 64)),
                   sx(64, bv(18446744073709551615, 64))),
        ]
        self.check_ast(tests)
    ...
    def test_smod(self):
        ...
        tests = [
            ...
            bvsmod(zx(64, bv(18446744073709318393, 64)),
                   sx(64, bv(18446744073709551571, 64))),
            bvsmod(zx(64, bv(9223372036854775808, 64)),
                   sx(64, bv(18446744073709551615, 64))),
        ]
        self.check_ast(tests)
