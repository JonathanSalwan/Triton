...
def emu_with_unicorn(opcode, istate):
    ...
    mu.emu_start(istate['pc'] | 1, istate['pc'] + len(opcode))
...
if __name__ == '__main__':
    ...
    for opcode, disassembly in CODE:
        ...
        # print("uc_state.pc = {:x}, tt_state.pc = {:x}".format(uc_state['pc'], tt_state['pc']))

        curr_addr += len(opcode)        # FIXME: Check issue with updating PC.
        tt_state['pc'] = curr_addr
