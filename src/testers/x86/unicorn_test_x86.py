...
CODE  = [
    ...
    (b"\x66\x0f\x3a\x16\xc8\x07",                   "pextrd eax, xmm1, 8"),
    (b"\x66\x0f\x3a\x16\xc8\x08",                   "pextrd eax, xmm1, 9"),
    (b"\x66\x0f\x3a\x16\xc8\x09",                   "pextrd eax, xmm1, 10"),
    (b"\x66\x0f\x3a\x16\xc8\x0a",                   "pextrd eax, xmm1, 11"),
    (b"\x66\x0f\x3a\x16\xc8\x0b",                   "pextrd eax, xmm1, 12"),
    (b"\x66\x0f\x3a\x16\xc8\x0c",                   "pextrd eax, xmm1, 13"),
    (b"\x66\x0f\x3a\x16\xc8\x0d",                   "pextrd eax, xmm1, 14"),
    (b"\x66\x0f\x3a\x16\xc8\x0e",                   "pextrd eax, xmm1, 15"),
    (b"\x66\x0f\x3a\x16\xc8\x0f",                   "pextrd eax, xmm1, 16"),
    (b"\x66\x0f\x3a\x16\xc8\x10",                   "pextrd eax, xmm1, 17"),
    (b"\x66\x0f\x3a\x16\xc8\x11",                   "pextrd eax, xmm1, 18"),
    (b"\x66\x0f\x3a\x16\xc8\x12",                   "pextrd eax, xmm1, 19"),
    (b"\x66\x0f\x3a\x16\xc8\x13",                   "pextrd eax, xmm1, 20"),
    (b"\x66\x0f\x3a\x16\xc8\x14",                   "pextrd eax, xmm1, 21"),
    (b"\x66\x0f\x3a\x16\xc8\x15",                   "pextrd eax, xmm1, 22"),
    (b"\x66\x0f\x3a\x16\xc8\x16",                   "pextrd eax, xmm1, 23"),
    (b"\x66\x0f\x3a\x16\xc8\x17",                   "pextrd eax, xmm1, 24"),
    (b"\x66\x0f\x3a\x16\xc8\x18",                   "pextrd eax, xmm1, 25"),
    (b"\x66\x0f\x3a\x16\xc8\x19",                   "pextrd eax, xmm1, 26"),
    (b"\x66\x0f\x3a\x16\xc8\x1a",                   "pextrd eax, xmm1, 27"),
    (b"\x66\x0f\x3a\x16\xc8\x1b",                   "pextrd eax, xmm1, 28"),
    (b"\x66\x0f\x3a\x16\xc8\x1c",                   "pextrd eax, xmm1, 29"),
    (b"\x66\x0f\x3a\x16\xc8\x1d",                   "pextrd eax, xmm1, 30"),
    (b"\x66\x0f\x3a\x16\xc8\x1e",                   "pextrd eax, xmm1, 31"),
    (b"\x66\x0f\x3a\x16\xc8\x1f",                   "pextrd eax, xmm1, 32"),
    (b"\x66\x0f\x3a\x16\xc8\x20",                   "pextrd eax, xmm1, 33"),
    ...
    (b"\xc4\xe3\x79\x16\xc8\x07",                   "vpextrd eax, xmm1, 8"),
    (b"\xc4\xe3\x79\x16\xc8\x08",                   "vpextrd eax, xmm1, 9"),
    (b"\xc4\xe3\x79\x16\xc8\x09",                   "vpextrd eax, xmm1, 10"),
    (b"\xc4\xe3\x79\x16\xc8\x0a",                   "vpextrd eax, xmm1, 11"),
    (b"\xc4\xe3\x79\x16\xc8\x0b",                   "vpextrd eax, xmm1, 12"),
    (b"\xc4\xe3\x79\x16\xc8\x0c",                   "vpextrd eax, xmm1, 13"),
    (b"\xc4\xe3\x79\x16\xc8\x0d",                   "vpextrd eax, xmm1, 14"),
    (b"\xc4\xe3\x79\x16\xc8\x0e",                   "vpextrd eax, xmm1, 15"),
    (b"\xc4\xe3\x79\x16\xc8\x0f",                   "vpextrd eax, xmm1, 16"),
    (b"\xc4\xe3\x79\x16\xc8\x10",                   "vpextrd eax, xmm1, 17"),
    (b"\xc4\xe3\x79\x16\xc8\x11",                   "vpextrd eax, xmm1, 18"),
    (b"\xc4\xe3\x79\x16\xc8\x12",                   "vpextrd eax, xmm1, 19"),
    (b"\xc4\xe3\x79\x16\xc8\x13",                   "vpextrd eax, xmm1, 20"),
    (b"\xc4\xe3\x79\x16\xc8\x14",                   "vpextrd eax, xmm1, 21"),
    (b"\xc4\xe3\x79\x16\xc8\x15",                   "vpextrd eax, xmm1, 22"),
    (b"\xc4\xe3\x79\x16\xc8\x16",                   "vpextrd eax, xmm1, 23"),
    (b"\xc4\xe3\x79\x16\xc8\x17",                   "vpextrd eax, xmm1, 24"),
    (b"\xc4\xe3\x79\x16\xc8\x18",                   "vpextrd eax, xmm1, 25"),
    (b"\xc4\xe3\x79\x16\xc8\x19",                   "vpextrd eax, xmm1, 26"),
    (b"\xc4\xe3\x79\x16\xc8\x1a",                   "vpextrd eax, xmm1, 27"),
    (b"\xc4\xe3\x79\x16\xc8\x1b",                   "vpextrd eax, xmm1, 28"),
    (b"\xc4\xe3\x79\x16\xc8\x1c",                   "vpextrd eax, xmm1, 29"),
    (b"\xc4\xe3\x79\x16\xc8\x1d",                   "vpextrd eax, xmm1, 30"),
    (b"\xc4\xe3\x79\x16\xc8\x1e",                   "vpextrd eax, xmm1, 31"),
    (b"\xc4\xe3\x79\x16\xc8\x1f",                   "vpextrd eax, xmm1, 32"),
