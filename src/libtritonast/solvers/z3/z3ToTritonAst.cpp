...
namespace triton {
  namespace ast {
    ...
    Z3ToTritonAst::Z3ToTritonAst(Context& astCtxt)
      : astCtxt(astCtxt) {
    }
    ...
    SharedAbstractNode Z3ToTritonAst::convert(const z3::expr& expr) {
      ...
      if (expr.is_quantifier())
        throw triton::ast::exceptions::AstTranslations("Z3ToTritonAst::visit(): Quantifier not supported yet.");

      if (!expr.is_app())
        throw triton::ast::exceptions::AstTranslations("Z3ToTritonAst::visit(): At this moment only application are supported.");
      ...
      switch (function.decl_kind()) {
        ...
        case Z3_OP_EQ: {
          if (expr.num_args() != 2)
            throw triton::ast::exceptions::AstTranslations("Z3ToTritonAst::visit(): Z3_OP_EQ must contain two arguments.");
        ...
        case Z3_OP_DISTINCT: {
          if (expr.num_args() < 2)
            throw triton::ast::exceptions::AstTranslations("Z3ToTritonAst::visit(): Z3_OP_DISTINCT must contain at least two arguments.");
        ...
        case Z3_OP_ITE: {
          if (expr.num_args() != 3)
            throw triton::ast::exceptions::AstTranslations("Z3ToTritonAst::visit(): Z3_OP_ITE must contain three arguments.");
        ...
        case Z3_OP_AND: {
          if (expr.num_args() < 2)
            throw triton::ast::exceptions::AstTranslations("Z3ToTritonAst::visit(): Z3_OP_AND must contain at least two arguments.");
        ...
        case Z3_OP_OR: {
          if (expr.num_args() < 2)
            throw triton::ast::exceptions::AstTranslations("Z3ToTritonAst::visit(): Z3_OP_OR must contain at least two arguments.");
        ...
        case Z3_OP_NOT: {
          if (expr.num_args() != 1)
            throw triton::ast::exceptions::AstTranslations("Z3ToTritonAst::visit(): Z3_OP_NOT must contain one argument.");
        ...
        case Z3_OP_BNEG: {
          if (expr.num_args() != 1)
            throw triton::ast::exceptions::AstTranslations("Z3ToTritonAst::visit(): Z3_OP_BNEG must contain one argument.");
        ...
        case Z3_OP_BADD: {
          if (expr.num_args() < 2)
            throw triton::ast::exceptions::AstTranslations("Z3ToTritonAst::visit(): Z3_OP_BADD must contain at least two arguments.");
        ...
        case Z3_OP_BSUB: {
          if (expr.num_args() < 2)
            throw triton::ast::exceptions::AstTranslations("Z3ToTritonAst::visit(): Z3_OP_BSUB must contain at least two arguments.");
        ...
        case Z3_OP_BMUL: {
          if (expr.num_args() < 2)
            throw triton::ast::exceptions::AstTranslations("Z3ToTritonAst::visit(): Z3_OP_BMUL must contain at least two arguments.");
        ...
        case Z3_OP_BSDIV: {
          if (expr.num_args() < 2)
            throw triton::ast::exceptions::AstTranslations("Z3ToTritonAst::visit(): Z3_OP_BSDIV must contain at least two arguments.");
        ...
        case Z3_OP_BUDIV: {
          if (expr.num_args() < 2)
            throw triton::ast::exceptions::AstTranslations("Z3ToTritonAst::visit(): Z3_OP_BUDIV must contain at least two arguments.");
        ...
        case Z3_OP_BSREM: {
          if (expr.num_args() < 2)
            throw triton::ast::exceptions::AstTranslations("Z3ToTritonAst::visit(): Z3_OP_BSREM must contain at least two arguments.");
        ...
        case Z3_OP_BUREM: {
          if (expr.num_args() < 2)
            throw triton::ast::exceptions::AstTranslations("Z3ToTritonAst::visit(): Z3_OP_BUREM must contain at least two arguments.");
        ...
        case Z3_OP_BSMOD: {
          if (expr.num_args() < 2)
            throw triton::ast::exceptions::AstTranslations("Z3ToTritonAst::visit(): Z3_OP_BSMOD must contain at least two arguments.");
        ...
        case Z3_OP_ULEQ: {
          if (expr.num_args() < 2)
            throw triton::ast::exceptions::AstTranslations("Z3ToTritonAst::visit(): Z3_OP_ULEQ must contain at least two arguments.");
        ...
        case Z3_OP_SLEQ: {
          if (expr.num_args() < 2)
            throw triton::ast::exceptions::AstTranslations("Z3ToTritonAst::visit(): Z3_OP_SLEQ must contain at least two arguments.");
        ...
        case Z3_OP_UGEQ: {
          if (expr.num_args() < 2)
            throw triton::ast::exceptions::AstTranslations("Z3ToTritonAst::visit(): Z3_OP_UGEQ must contain at least two arguments.");
        ...
        case Z3_OP_SGEQ: {
          if (expr.num_args() < 2)
            throw triton::ast::exceptions::AstTranslations("Z3ToTritonAst::visit(): Z3_OP_SGEQ must contain at least two arguments.");
        ...
        case Z3_OP_ULT: {
          if (expr.num_args() < 2)
            throw triton::ast::exceptions::AstTranslations("Z3ToTritonAst::visit(): Z3_OP_ULT must contain at least two arguments.");
        ...
        case Z3_OP_SLT: {
          if (expr.num_args() < 2)
            throw triton::ast::exceptions::AstTranslations("Z3ToTritonAst::visit(): Z3_OP_SLT must contain at least two arguments.");
        ...
        case Z3_OP_UGT: {
          if (expr.num_args() < 2)
            throw triton::ast::exceptions::AstTranslations("Z3ToTritonAst::visit(): Z3_OP_UGT must contain at least two arguments.");
        ...
        case Z3_OP_SGT: {
          if (expr.num_args() < 2)
            throw triton::ast::exceptions::AstTranslations("Z3ToTritonAst::visit(): Z3_OP_SGT must contain at least two arguments.");
        ...
        case Z3_OP_BAND: {
          if (expr.num_args() < 2)
            throw triton::ast::exceptions::AstTranslations("Z3ToTritonAst::visit(): Z3_OP_BAND must contain at least two arguments.");
        ...
        case Z3_OP_BOR: {
          if (expr.num_args() < 2)
            throw triton::ast::exceptions::AstTranslations("Z3ToTritonAst::visit(): Z3_OP_BOR must contain at least two arguments.");
        ...
        case Z3_OP_BNOT: {
          if (expr.num_args() != 1)
            throw triton::ast::exceptions::AstTranslations("Z3ToTritonAst::visit(): Z3_OP_BNOT must contain one argument.");
        ...
        case Z3_OP_BXOR: {
          if (expr.num_args() < 2)
            throw triton::ast::exceptions::AstTranslations("Z3ToTritonAst::visit(): Z3_OP_BXOR must contain at least two arguments.");
        ...
        case Z3_OP_BNAND: {
          if (expr.num_args() < 2)
            throw triton::ast::exceptions::AstTranslations("Z3ToTritonAst::visit(): Z3_OP_BNAND must contain at least two arguments.");
        ...
        case Z3_OP_BNOR: {
          if (expr.num_args() < 2)
            throw triton::ast::exceptions::AstTranslations("Z3ToTritonAst::visit(): Z3_OP_BNOR must contain at least two arguments.");
        ...
        case Z3_OP_BXNOR: {
          if (expr.num_args() < 2)
            throw triton::ast::exceptions::AstTranslations("Z3ToTritonAst::visit(): Z3_OP_BXNOR must contain at least two arguments.");
        ...
        case Z3_OP_CONCAT: {
          if (expr.num_args() < 2)
            throw triton::ast::exceptions::AstTranslations("Z3ToTritonAst::visit(): Z3_OP_CONCAT must contain at least two arguments.");
        ...
        case Z3_OP_SIGN_EXT: {
          if (expr.num_args() != 1)
            throw triton::ast::exceptions::AstTranslations("Z3ToTritonAst::visit(): Z3_OP_SIGN_EXT must contain one argument.");
        ...
        case Z3_OP_ZERO_EXT: {
          if (expr.num_args() != 1)
            throw triton::ast::exceptions::AstTranslations("Z3ToTritonAst::visit(): Z3_OP_ZERO_EXT must contain one argument.");
        ...
        case Z3_OP_EXTRACT: {
          if (expr.num_args() != 1)
            throw triton::ast::exceptions::AstTranslations("Z3ToTritonAst::visit(): Z3_OP_EXTRACT must contain one argument.");
        ...
        case Z3_OP_BSHL: {
          if (expr.num_args() < 2)
            throw triton::ast::exceptions::AstTranslations("Z3ToTritonAst::visit(): Z3_OP_BSHL must contain at least two arguments.");
        ...
        case Z3_OP_BLSHR: {
          if (expr.num_args() < 2)
            throw triton::ast::exceptions::AstTranslations("Z3ToTritonAst::visit(): Z3_OP_BLSHR must contain at least two arguments.");
        ...
        case Z3_OP_BASHR: {
          if (expr.num_args() < 2)
            throw triton::ast::exceptions::AstTranslations("Z3ToTritonAst::visit(): Z3_OP_BASHR must contain at least two arguments.");
        ...
        case Z3_OP_ROTATE_LEFT: {
          if (expr.num_args() != 1)
            throw triton::ast::exceptions::AstTranslations("Z3ToTritonAst::visit(): Z3_OP_ROTATE_LEFT must contain one argument.");
        ...
        case Z3_OP_ROTATE_RIGHT: {
          if (expr.num_args() != 1)
            throw triton::ast::exceptions::AstTranslations("Z3ToTritonAst::visit(): Z3_OP_ROTATE_RIGHT must contain one argument.");
        ...
        default:
          throw triton::ast::exceptions::AstTranslations("Z3ToTritonAst::visit(): '" + function.name().str() + "' AST node not supported yet");
      }
