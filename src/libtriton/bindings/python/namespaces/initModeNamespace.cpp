  ...
  namespace bindings {
    namespace python {
      ...
      void initModeNamespace(PyObject* modeDict) {
        PyDict_SetItemStringSteal(modeDict, "ALIGNED_MEMORY",         PyLong_FromUint32(triton::modes::ALIGNED_MEMORY));
        PyDict_SetItemStringSteal(modeDict, "ONLY_ON_SYMBOLIZED",     PyLong_FromUint32(triton::modes::ONLY_ON_SYMBOLIZED));
        PyDict_SetItemStringSteal(modeDict, "ONLY_ON_TAINTED",        PyLong_FromUint32(triton::modes::ONLY_ON_TAINTED));
        PyDict_SetItemStringSteal(modeDict, "PC_TRACKING_SYMBOLIC",   PyLong_FromUint32(triton::modes::PC_TRACKING_SYMBOLIC));
      }
