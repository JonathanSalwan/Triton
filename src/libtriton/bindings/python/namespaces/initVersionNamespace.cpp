  ...
  namespace bindings {
    namespace python {
      ...
      void initVersionNamespace(PyObject* versionDict) {
        PyDict_SetItemStringSteal(versionDict, "MAJOR", PyLong_FromUint32(triton::MAJOR));
        PyDict_SetItemStringSteal(versionDict, "MINOR", PyLong_FromUint32(triton::MINOR));
        PyDict_SetItemStringSteal(versionDict, "BUILD", PyLong_FromUint32(triton::BUILD));
      }
