    ...
    namespace x86 {
      ...
      x86Specifications::x86Specifications(triton::arch::architectures_e arch) {
        ...
        if (arch == triton::arch::ARCH_X86_64) {
          // Fill registers_ with those available in X86_64 from spec
            ...
            registers_.emplace(ID_REG_##ARCH##_##UPPER_NAME,                                                                                        \
                               triton::arch::Register(triton::arch::ID_REG_##ARCH##_##UPPER_NAME,                                                   \
                                                      #LOWER_NAME,                                                                                  \
                                                      triton::arch::ID_REG_##ARCH##_##X86_64_PARENT,                                                \
                                                      X86_64_UPPER,                                                                                 \
                                                      X86_64_LOWER)                                                                                 \
                              );
          ...
          #define REG_SPEC(UPPER_NAME, LOWER_NAME, ARCH, _1, _2, _3, X86_UPPER, X86_LOWER, X86_PARENT, X86_AVAIL)                                   \
          if (X86_AVAIL)                                                                                                                            \
            registers_.emplace(ID_REG_##ARCH##_##UPPER_NAME,                                                                                        \
                               triton::arch::Register(triton::arch::ID_REG_##ARCH##_##UPPER_NAME,                                                   \
                                                      #LOWER_NAME,                                                                                  \
                                                      triton::arch::ID_REG_##ARCH##_##X86_PARENT,                                                   \
                                                      X86_UPPER,                                                                                    \
                                                      X86_LOWER)                                                                                    \
                              );
          // Handle register not available in capstone as normal registers
      ...
      triton::arch::registers_e x86Specifications::capstoneRegisterToTritonRegister(triton::uint32 id) const {
        ...
        switch (id) {
          ...
          case triton::extlibs::capstone::X86_REG_##UPPER_NAME:                                                                                     \
            tritonId = triton::arch::ID_REG_##ARCH##_##UPPER_NAME;                                                                                  \
            break;
          // Ignore registers not available in capstone
          #define REG_SPEC_NO_CAPSTONE(UPPER_NAME, LOWER_NAME, ARCH, X86_64_UPPER, X86_64_LOWER, X86_64_PARENT, X86_UPPER, X86_LOWER, X86_PARENT, X86_AVAIL)
          #include "triton/x86.spec"
