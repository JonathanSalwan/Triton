...
namespace triton {
  namespace arch {
    ...
    bool x8664Cpu::isRegister(triton::uint32 regId) {
      return (this->isGPR(regId) || this->isMMX(regId) || this->isSSE(regId) || this->isAVX256(regId) || this->isAVX512(regId) || this->isSegment(regId));
    }
