    ...
    namespace x86 {
      namespace semantics {
        ...
        void call_s(triton::arch::Instruction& inst) {
          ...
          auto sp   = triton::arch::OperandWrapper(inst.popMemoryAccess());
          auto src  = inst.operands[0];
        ...
        void cmova_s(triton::arch::Instruction& inst) {
          ...
          if ((!triton::api.getLastRegisterValue(TRITON_X86_REG_CF) & !triton::api.getLastRegisterValue(TRITON_X86_REG_ZF)) == true) {
        ...
        void cmovae_s(triton::arch::Instruction& inst) {
          ...
          /* Spread taint and condition flag */
          if (!triton::api.getLastRegisterValue(TRITON_X86_REG_CF)) {
            expr->isTainted = triton::api.taintAssignment(dst, src);
            inst.setConditionTaken(true);
          }
          else
        ...
        void cmovbe_s(triton::arch::Instruction& inst) {
          ...
          /* Spread taint and condition flag */
          if (triton::api.getLastRegisterValue(TRITON_X86_REG_CF) | triton::api.getLastRegisterValue(TRITON_X86_REG_ZF)) {
            expr->isTainted = triton::api.taintAssignment(dst, src);
            inst.setConditionTaken(true);
          }
          else
        ...
        void cmove_s(triton::arch::Instruction& inst) {
          ...
          /* Spread taint and condition flag */
          if (triton::api.getLastRegisterValue(TRITON_X86_REG_ZF)) {
            expr->isTainted = triton::api.taintAssignment(dst, src);
            inst.setConditionTaken(true);
          }
          else
        ...
        void cmovg_s(triton::arch::Instruction& inst) {
          ...
          /* Spread taint and condition flag */
          if (((triton::api.getLastRegisterValue(TRITON_X86_REG_SF) ^ triton::api.getLastRegisterValue(TRITON_X86_REG_OF)) | triton::api.getLastRegisterValue(TRITON_X86_REG_ZF)) == false) {
            expr->isTainted = triton::api.taintAssignment(dst, src);
            inst.setConditionTaken(true);
          }
          else
        ...
        void cmovge_s(triton::arch::Instruction& inst) {
          ...
          /* Spread taint and condition flag */
          if (triton::api.getLastRegisterValue(TRITON_X86_REG_SF) == triton::api.getLastRegisterValue(TRITON_X86_REG_OF)) {
            expr->isTainted = triton::api.taintAssignment(dst, src);
            inst.setConditionTaken(true);
          }
          else
        ...
        void cmovle_s(triton::arch::Instruction& inst) {
          ...
          /* Spread taint and condition flag */
          if (((triton::api.getLastRegisterValue(TRITON_X86_REG_SF) ^ triton::api.getLastRegisterValue(TRITON_X86_REG_OF)) | triton::api.getLastRegisterValue(TRITON_X86_REG_ZF)) == true) {
            expr->isTainted = triton::api.taintAssignment(dst, src);
            inst.setConditionTaken(true);
          }
          else
        ...
        void cmovno_s(triton::arch::Instruction& inst) {
          ...
          /* Spread taint and condition flag */
          if (!triton::api.getLastRegisterValue(TRITON_X86_REG_OF)) {
            expr->isTainted = triton::api.taintAssignment(dst, src);
            inst.setConditionTaken(true);
          }
          else
        ...
        void cmovnp_s(triton::arch::Instruction& inst) {
          ...
          /* Spread taint and condition flag */
          if (!triton::api.getLastRegisterValue(TRITON_X86_REG_PF)) {
            expr->isTainted = triton::api.taintAssignment(dst, src);
            inst.setConditionTaken(true);
          }
          else
        ...
        void cmovns_s(triton::arch::Instruction& inst) {
          ...
          /* Spread taint and condition flag */
          if (!triton::api.getLastRegisterValue(TRITON_X86_REG_SF)) {
            expr->isTainted = triton::api.taintAssignment(dst, src);
            inst.setConditionTaken(true);
          }
          else
        ...
        void leave_s(triton::arch::Instruction& inst) {
          auto bp1 = triton::arch::OperandWrapper(inst.popMemoryAccess());
          auto bp2 = triton::arch::OperandWrapper(TRITON_X86_REG_BP.getParent());
          auto sp  = triton::arch::OperandWrapper(TRITON_X86_REG_SP.getParent());
        ...
        void pop_s(triton::arch::Instruction& inst) {
          auto dst = inst.operands[0];
          auto src = triton::arch::OperandWrapper(inst.popMemoryAccess());
        ...
        void push_s(triton::arch::Instruction& inst) {
          auto dst = triton::arch::OperandWrapper(inst.popMemoryAccess());
          auto src = inst.operands[0];
