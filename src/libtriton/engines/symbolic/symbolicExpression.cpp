...
namespace triton {
  namespace engines {
    namespace symbolic {
      ...
      SymbolicExpression::SymbolicExpression(triton::arch::CpuInterface const& cpu, triton::ast::AbstractNode* node, triton::usize id, symkind_e kind, const std::string& comment) : originMemory(cpu), originRegister(cpu) {
