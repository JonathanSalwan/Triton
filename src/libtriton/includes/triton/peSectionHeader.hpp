     ...
     */
      ...
      class PeSectionHeader {
        protected:
          ...
          struct {
            /*!
             * \details Section name. If it's 8 bytes long then it's not null-terminated.
             */
            triton::uint8 name[8];

            /*!
             * \details The total size of the section when loaded into memory. If this value is greater than SizeOfRawData, the section is zero-padded.
             */
            triton::uint32 virtualSize;

            /*!
             * \details The address of the first byte of the section relative to the image base when the section is loaded into memory.
             */
            triton::uint32 virtualAddress;

            /*!
             * \details the Size of the initialized data on disk.
             */
            triton::uint32 rawSize;

            /*!
             * \details The file pointer to the first page of the section within the file.
             */
            triton::uint32 rawAddress;

            /*!
             * \details The file pointer to the beginning of relocation entries for the section.
             */
            triton::uint32 pointerToRelocations;

            /*!
             * \details The file pointer to the beginning of line-number entries for the section. (deprecated)
             */
            triton::uint32 pointerToLinenumbers;

            /*!
             * \details The number of relocation entries for the section.
             */
            triton::uint16 numberOfRelocations;

            /*!
             * \details The number of line-number entries for the section. (deprecated)
             */
            triton::uint16 numberOfLinenumbers;

            /*!
             * \details The flags that describe the characteristics of the section.
             */
