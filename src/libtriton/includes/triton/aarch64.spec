...
// Vector Register
REG_SPEC(V0,  v0,  triton::bitsize::dqword-1, 0, V0,  TT_MUTABLE_REG) // v0
REG_SPEC(V1,  v1,  triton::bitsize::dqword-1, 0, V1,  TT_MUTABLE_REG) // v1
REG_SPEC(V2,  v2,  triton::bitsize::dqword-1, 0, V2,  TT_MUTABLE_REG) // v2
REG_SPEC(V3,  v3,  triton::bitsize::dqword-1, 0, V3,  TT_MUTABLE_REG) // v3
REG_SPEC(V4,  v4,  triton::bitsize::dqword-1, 0, V4,  TT_MUTABLE_REG) // v4
REG_SPEC(V5,  v5,  triton::bitsize::dqword-1, 0, V5,  TT_MUTABLE_REG) // v5
REG_SPEC(V6,  v6,  triton::bitsize::dqword-1, 0, V6,  TT_MUTABLE_REG) // v6
REG_SPEC(V7,  v7,  triton::bitsize::dqword-1, 0, V7,  TT_MUTABLE_REG) // v7
REG_SPEC(V8,  v8,  triton::bitsize::dqword-1, 0, V8,  TT_MUTABLE_REG) // v8
REG_SPEC(V9,  v9,  triton::bitsize::dqword-1, 0, V9,  TT_MUTABLE_REG) // v9
REG_SPEC(V10, v10, triton::bitsize::dqword-1, 0, V10, TT_MUTABLE_REG) // v10
REG_SPEC(V11, v11, triton::bitsize::dqword-1, 0, V11, TT_MUTABLE_REG) // v11
REG_SPEC(V12, v12, triton::bitsize::dqword-1, 0, V12, TT_MUTABLE_REG) // v12
REG_SPEC(V13, v13, triton::bitsize::dqword-1, 0, V13, TT_MUTABLE_REG) // v13
REG_SPEC(V14, v14, triton::bitsize::dqword-1, 0, V14, TT_MUTABLE_REG) // v14
REG_SPEC(V15, v15, triton::bitsize::dqword-1, 0, V15, TT_MUTABLE_REG) // v15
REG_SPEC(V16, v16, triton::bitsize::dqword-1, 0, V16, TT_MUTABLE_REG) // v16
REG_SPEC(V17, v17, triton::bitsize::dqword-1, 0, V17, TT_MUTABLE_REG) // v17
REG_SPEC(V18, v18, triton::bitsize::dqword-1, 0, V18, TT_MUTABLE_REG) // v18
REG_SPEC(V19, v19, triton::bitsize::dqword-1, 0, V19, TT_MUTABLE_REG) // v19
REG_SPEC(V20, v20, triton::bitsize::dqword-1, 0, V20, TT_MUTABLE_REG) // v20
REG_SPEC(V21, v21, triton::bitsize::dqword-1, 0, V21, TT_MUTABLE_REG) // v21
REG_SPEC(V22, v22, triton::bitsize::dqword-1, 0, V22, TT_MUTABLE_REG) // v22
REG_SPEC(V23, v23, triton::bitsize::dqword-1, 0, V23, TT_MUTABLE_REG) // v23
REG_SPEC(V24, v24, triton::bitsize::dqword-1, 0, V24, TT_MUTABLE_REG) // v24
REG_SPEC(V25, v25, triton::bitsize::dqword-1, 0, V25, TT_MUTABLE_REG) // v25
REG_SPEC(V26, v26, triton::bitsize::dqword-1, 0, V26, TT_MUTABLE_REG) // v26
REG_SPEC(V27, v27, triton::bitsize::dqword-1, 0, V27, TT_MUTABLE_REG) // v27
REG_SPEC(V28, v28, triton::bitsize::dqword-1, 0, V28, TT_MUTABLE_REG) // v28
REG_SPEC(V29, v29, triton::bitsize::dqword-1, 0, V29, TT_MUTABLE_REG) // v29
REG_SPEC(V30, v30, triton::bitsize::dqword-1, 0, V30, TT_MUTABLE_REG) // v30
REG_SPEC(V31, v31, triton::bitsize::dqword-1, 0, V31, TT_MUTABLE_REG) // v31
