     ...
     */
      ...
      class x86Semantics : public SemanticsInterface {
        ...
        public:
          ...
          //! Clears a flag.
          void clearFlag_s(triton::arch::Instruction& inst, const triton::arch::RegisterSpec& flag, std::string comment="");

          //! Sets a flag.
          void setFlag_s(triton::arch::Instruction& inst, const triton::arch::RegisterSpec& flag, std::string comment="");
