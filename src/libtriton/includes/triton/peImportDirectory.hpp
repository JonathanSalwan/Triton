   ...
   */
     ...
     */
      ...
      struct PeImportLookup {
        /*!
         * \details Indicates whether the import is by name or ordinal number.
         */
        bool importByName;

        /*!
         * \details If the import is by ordinal number, this is the ordinal numer, otherwise it's the "hint" that accompanies the import by name.
         */
        triton::uint16 ordinalNumber;

        /*!
         * \details If the import is by name, this is the name of the imported function.
         */
        std::string name;
      };
      ...
      class PeImportDirectory {
        protected:
          ...
          struct {
            /*!
             * \details The RVA of the import lookup table. This table contains a name or ordinal for each import. (The name "Characteristics" is used in Winnt.h, but no longer describes this field.)
             */
            triton::uint32 importLookupTableRVA;

            /*!
             * \details The stamp that is set to zero until the image is bound. After the image is bound, this field is set to the time/data stamp of the DLL.
             */
            triton::uint32 timeDateStamp;

            /*!
             * \details The index of the first forwarder reference.
             */
            triton::uint32 forwarderChain;

            /*!
             * \details The address of an ASCII string that contains the name of the DLL. This address is relative to the image base.
             */
            triton::uint32 nameRVA;

            /*!
             * \details The RVA of the import address table. The contents of this table are identical to the contents of the import lookup table until the image is bound.
             */
            triton::uint32 importAddressTableRVA;
          } st;

          /*!
           * \details The name at nameRVA as a string.
           */
          std::string name;

          /*!
           * \details The list of entries in the import directory.
           */
