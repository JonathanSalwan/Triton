...
REG_SPEC(ST0, st0, QWORD_SIZE_BIT-1, 0, ST0, QWORD_SIZE_BIT-1, 0, ST0, true) // st0
REG_SPEC(ST1, st1, QWORD_SIZE_BIT-1, 0, ST1, QWORD_SIZE_BIT-1, 0, ST1, true) // st1
REG_SPEC(ST2, st2, QWORD_SIZE_BIT-1, 0, ST2, QWORD_SIZE_BIT-1, 0, ST2, true) // st2
REG_SPEC(ST3, st3, QWORD_SIZE_BIT-1, 0, ST3, QWORD_SIZE_BIT-1, 0, ST3, true) // st3
REG_SPEC(ST4, st4, QWORD_SIZE_BIT-1, 0, ST4, QWORD_SIZE_BIT-1, 0, ST4, true) // st4
REG_SPEC(ST5, st5, QWORD_SIZE_BIT-1, 0, ST5, QWORD_SIZE_BIT-1, 0, ST5, true) // st5
REG_SPEC(ST6, st6, QWORD_SIZE_BIT-1, 0, ST6, QWORD_SIZE_BIT-1, 0, ST6, true) // st6
REG_SPEC(ST7, st7, QWORD_SIZE_BIT-1, 0, ST7, QWORD_SIZE_BIT-1, 0, ST7, true) // st7
