...
namespace EflagsExpressions {
  ...
  smt2lib::smtAstAbstractNode *cfRcl(SymbolicExpression *parent, uint32 bvSize, smt2lib::smtAstAbstractNode *op2);
  smt2lib::smtAstAbstractNode *cfRol(SymbolicExpression *parent, smt2lib::smtAstAbstractNode *op2);
  smt2lib::smtAstAbstractNode *cfRor(SymbolicExpression *parent, uint32 bvSize, smt2lib::smtAstAbstractNode *op2);
  ...
  smt2lib::smtAstAbstractNode *ofRol(SymbolicExpression *parent, uint32 bvSize, smt2lib::smtAstAbstractNode *op2);
  smt2lib::smtAstAbstractNode *ofRor(SymbolicExpression *parent, uint32 bvSize, smt2lib::smtAstAbstractNode *op2);
  ...
  smt2lib::smtAstAbstractNode *ofShr(SymbolicExpression *parent, uint32 bvSize, smt2lib::smtAstAbstractNode *op1, smt2lib::smtAstAbstractNode *op2);
  ...
  smt2lib::smtAstAbstractNode *pfShl(SymbolicExpression *parent, uint32 bvSize, smt2lib::smtAstAbstractNode *op2);
  ...
  smt2lib::smtAstAbstractNode *zfShl(SymbolicExpression *parent, uint32 bvSize, smt2lib::smtAstAbstractNode *op2);
}
